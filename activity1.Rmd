...
Normally, we don't want our programs just to print out text. Some programs might expect user interaction. Next, we are going to write a program the prompts a user for an input, in this case your name. It stores the name in the variable 'name' and then prints the name out.
