...
We have created an empty Jupyter notebook for you to use at the following [link](https://mybinder.org/v2/gh/ejjohnson93/outreach_jupyter/HEAD?labpath=index.ipynb). It should look like this:
